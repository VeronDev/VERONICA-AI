...
async function writeExifImg(media, metadata = {}) {
	...
	if (metadata.packname || metadata.author) {
		...
		const json = {
			'sticker-pack-id': `https://github.com/VeronDev/VERONICA-AI`,
...
export const createSticker = async buffer => {
	...
	let res;
	const options = { packname: config.STICKER_PACK.split(';')[0] || 'Vᴇʀᴏɴɪᴄᴀ Aɪ', author: config.STICKER_PACK.split(';')[1] || 'VᴇʀᴏɴDᴇᴠ' };
